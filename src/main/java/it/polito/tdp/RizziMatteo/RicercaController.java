...
public class RicercaController {
    ...
    void avviaRicerca(ActionEvent event) {
    	...
    	case "Trova gli artisti dato il nome o una parte di esso":
    		...
    		if(nome.equals("")) {
    			this.lblErrore.setText("Errore! Devi inserire il nome di un'artista o una parte di esso nell'apposita casella di testo.");
    		} else {
    	...
    	case "Trova gli artisti per numero medio di biglietti venduti":
    		...
    		try {
    			...
    			this.lblErrore.setText("Errore! Devi inserire un valore decimale per il numero medio di biglietti venduti nell'apposita casella di testo.");
    		}
    		break;
    	case "Trova gli artisti per cachet":
    		Long cachet;
    		try {
    			...
    			this.lblErrore.setText("Errore! Devi inserire un valore intero per il cachet medio nell'apposita casella di testo.");
    		}
    		break;
    	}
